...
//            avatarUrl = "http://127.0.0.1:8888/images/" + avatar;
//        }
//        return avatarUrl;
//    }
//
...
//            avatarUrl = "http://127.0.0.1:8888/images/" + pic;
//        }
//        return avatarUrl;
//    }
//}
...
public class PicUrlUtil {
    ...
    /**
     * 获取完整图片路径
     * 由于数据库中的图片url路径为本地存储路径的后缀，所以返回给前端前需要将路径补全
     * @param avatar 头像路径后缀
     * @return 完整头像url
     */
    public static String getFullAvatarUrl(String avatar) {
